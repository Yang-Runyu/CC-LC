...
public:
	...
	Static_Data_Model(unsigned number_of_symbols);
	~Static_Data_Model(void);
...
public:
	...
	void set_alphabet(unsigned number_of_symbols);
	void printPro(void);
	void setPro(float prob[]);
	void copy(Adaptive_Data_Model &, int start);
	void copy(int* count_list, int low);
	void copy(int* count_list);
	float get_bits(unsigned data);
	float get_bits(unsigned data, int forbidden);
	int get_count();

	unsigned * distribution, *distribution_forbidden, *symbol_count, *decoder_table;
...
public:
	...
	void     encode(unsigned data,
		Adaptive_Data_Model &);
	void     noencode(unsigned data,
		Adaptive_Data_Model &);

	unsigned decode(Adaptive_Data_Model &);
	void nodecode(Adaptive_Data_Model &, int s);

	void     encode(unsigned data, Adaptive_Data_Model &, int forbidden);
	unsigned decode(Adaptive_Data_Model &, int forbidden);

	void     encode(unsigned data, Adaptive_Data_Model &, int forbidden1, int forbidden2);
	unsigned decode(Adaptive_Data_Model &, int forbidden1, int forbidden2);
